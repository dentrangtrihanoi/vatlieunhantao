...
export const generateMetadata = async (): Promise<Metadata> => {
  ...
  return {
    title: termsItem?.metaTitle || `Terms and Conditions | ${site_name}`,
    description: termsItem?.metaDescription || `This is Terms and Conditions for ${site_name}`,
    robots: {
      index: termsItem?.robotsIndex ?? true,
      follow: termsItem?.robotsFollow ?? true,
    },
    alternates: {
      canonical: `${process.env.SITE_URL}/terms-conditions`,
    },
  };
};
