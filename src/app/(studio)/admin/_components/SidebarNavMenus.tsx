...
const sidebarMenuData = [
  ...
  },
  {
    ...
    href: "/admin/menu",
    icon: <CategoryIcon />, // Using CategoryIcon for now, or could find a better one
  },
];
            ...
            <div key={index} className="flex flex-col gap-1">
              {hasChildren ? (
                <button
                  ...
                  className={`flex items-center justify-between w-full font-normal rounded-lg gap-2.5 py-2.5 px-3 text-sm text-left hover:bg-blue/10 hover:text-blue text-dark-2 ${isActive ? "bg-blue/10 text-blue" : "bg-transparent"
                    }`}
                >
