...
const OrderSummary = () => {
  ...
  const { cartCount, cartDetails, totalPrice = 0 } = useCart();
    ...
    <div className="w-full lg:col-span-4">
      ...
      <div className="bg-white shadow-1 rounded-[10px]">
        <div className="px-6 py-5 border-b border-gray-3">
          <h3 className="text-lg font-medium text-dark">Tóm tắt đơn hàng</h3>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between pb-5 border-b border-gray-3">
            ...
            <div>
              <h4 className="font-medium text-right text-dark">Tạm tính</h4>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-5">
            <div>
              <p className="text-lg font-medium text-dark">Tổng cộng</p>
            </div>
            <div>
