                    ...
                    <div className="flex items-center gap-2">
                      {product.quantity > 0 ? (
                        <>
                          ...
                          <span className="text-dark"> Còn hàng </span>
                        </>
                      ) : (
                        <>
                          <CircleCheckIcon className="fill-red" />
                          <span className="text-body"> Hết hàng </span>
                        </>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap justify-between gap-5 mt-6 mb-7.5">
                    <div>
                      ...
                      <span className="flex items-center gap-2">
                        <span
                          className={`text-lg font-medium ${product.discountedPrice ? 'text-dark-4' : 'text-dark'} xl:text-2xl ${product.discountedPrice ? "line-through" : ""
                            }`}
                        >
