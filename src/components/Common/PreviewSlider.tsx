...
const PreviewSliderModal = () => {
  ...
  return (
    ...
    <div
      className="fixed inset-0 z-999999 flex justify-center items-center bg-black/90"
    ...
    >
      ...
      <button
        ...
        aria-label="Đóng"
        className="absolute top-4 right-4 z-20 flex items-center justify-center w-10 h-10 rounded-full text-white hover:text-gray-300 transition-colors"
      >
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 text-white hover:text-gray-300 transition-colors"
      >
      ...
      <button
        ...
        aria-label="Ảnh sau"
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 text-white hover:text-gray-300 transition-colors"
      >
        <svg width="36" height="36" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Image content — stopPropagation so clicking image doesn't close modal */}
      <div
        onClick={(e) => e.stopPropagation()}
        className="relative w-full h-[85vh] px-20"
      >
        <Swiper ref={sliderRef} slidesPerView={1} spaceBetween={20} className="h-full">
