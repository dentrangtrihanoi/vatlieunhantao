  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px]">
      <div className="px-6 py-5 border-b border-gray-3">
        <h3 className="text-lg font-medium text-dark">Phương thức thanh toán</h3>
      </div>
      ...
      <div className="p-6">
        ...
        {paymentMethod === "cod" && (
          <p className="mt-5 text-green">
            Bạn đã chọn Thanh toán khi nhận hàng. Đơn hàng của bạn sẽ được xử lý và
            thanh toán sẽ được thu khi giao hàng.
          </p>
        )}
      </div>
    </div>
