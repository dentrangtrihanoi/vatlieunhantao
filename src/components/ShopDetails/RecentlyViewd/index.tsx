...
const RecentlyViewedItems = ({ products }: { products: Product[] }) => {
  ...
  return (
    <section className="overflow-hidden pt-4">
      <div className="w-full px-4 mx-auto border-b max-w-7xl sm:px-8 xl:px-0 pb-4 border-gray-3">
        <div className="swiper categories-carousel common-carousel">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={handleNext}
                className={`swiper-button-next ${(products.length <= visibleSlides || isEnd) && "opacity-50 pointer-events-none"
                  }`}
