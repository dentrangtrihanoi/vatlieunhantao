  ...
  return (
    <div className="max-w-[550px] w-full">
      <form onSubmit={handleSubmit}>
        <h2 className="font-medium text-xl text-dark mb-3.5">Thêm đánh giá</h2>
          ...
          <div className="flex items-center gap-1">
            {[...Array(5)].map((_, index) => {
              ...
              return (
                ...
                >
                  <span
                    className={`cursor-pointer ${index <= (hover || rating)
                      ? "text-[#FBB040]"
                      : "text-gray-5"
                      }`}
                  >
        ...
        <div className="p-4 bg-gray-2 rounded-xl shadow-1 sm:p-6">
          <div className="mb-5">
            <label
              htmlFor="comment"
