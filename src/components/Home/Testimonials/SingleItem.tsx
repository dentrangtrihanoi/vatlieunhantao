...
const SingleItem = ({ testimonial }: { testimonial: Testimonial }) => {
  return (
    <div className="p-2 border rounded-2xl border-[#F2F4F7] bg-[#F6F7FB]">
      <div className=" bg-white rounded-xl  py-7.5 px-4 ">
        ...
        <div className="flex items-center gap-4">
          <div className="w-12.5 h-12.5 rounded-full overflow-hidden relative">
            {testimonial.image ? (
              ...
              <div className="w-full h-full bg-gray-2 flex items-center justify-center text-xs">
                No Img
              </div>
            )}
          </div>
          ...
          <div>
            ...
            <p className="text-custom-sm">{testimonial.designation}</p>
          </div>
        </div>
      </div>
    </div>
