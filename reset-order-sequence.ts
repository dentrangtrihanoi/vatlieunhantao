...
async function main() {
    try {
        ...
        // Note: The sequence name is typically "ModelName_fieldName_seq". 
        // For Order model and orderNumber field, it should be "Order_orderNumber_seq".
        // Quoting identifiers is important for PostgreSQL case sensitivity.
